...
- [x] 1.1.1. Convert current project to umbrella structure
- [x] 1.1.2. Create apps/rubber_duck_core for business logic
- [x] 1.1.3. Create apps/rubber_duck_web for Phoenix/WebSocket layer
- [x] 1.1.4. Create apps/rubber_duck_engines for analysis engines
- [x] 1.1.5. Create apps/rubber_duck_storage for data persistence
- [x] 1.1.6. Update mix.exs files for each application
- [x] 1.1.7. Add core dependencies to each app (Phoenix, Ecto, GenStateMachine, etc.)
- [x] 1.1.8. Configure inter-app dependencies
- [x] 1.1.9. Set up shared configuration structure
- [x] 1.1.10. Create development/test/prod environment configs
...
- [x] 1.2.3. Add DynamicSupervisor for on-demand engine spawning
- [x] 1.2.4. Create EnginePool.Supervisor with rest_for_one strategy
...
- [x] 1.4.5. Configure Git hooks for pre-commit checks
...
- [x] 1.5.1.1. Design Project schema with fields (id, name, description, settings, created_at, updated_at)
- [x] 1.5.1.2. Create Project Ecto schema and migration
- [x] 1.5.1.3. Update Conversation schema to belong_to Project
- [x] 1.5.1.4. Update Message schema to reference Project through Conversation
- [x] 1.5.1.5. Update EngineSession schema to belong_to Project
- [x] 1.5.1.6. Update AnalysisResult schema to belong_to Project
- [x] 1.5.1.7. Add foreign key constraints and indexes for project relationships
- [x] 1.5.1.8. Create project-based data isolation queries
- [x] 1.5.1.9. Implement project settings and configuration schema
- [x] 1.5.1.10. Add project-level permissions and access control
...
- [x] 1.5.2.1. Create unified Repository module structure
- [x] 1.5.2.2. Implement project operations (add, remove, change, get, list)
- [x] 1.5.2.3. Implement project-scoped conversation operations
- [x] 1.5.2.4. Implement project-scoped message operations with batch support
- [x] 1.5.2.5. Implement project-scoped engine session operations
- [x] 1.5.2.6. Implement project-scoped analysis result operations
- [x] 1.5.2.7. Create unified transaction helpers with project context
- [x] 1.5.2.8. Implement cross-entity queries within project scope
- [x] 1.5.2.9. Add project-aware caching strategy
- [x] 1.5.2.10. Implement project-level bulk operations and cleanup
...
- [x] 1.5.3.1. Create data migration scripts to add project_id to existing records
- [x] 1.5.3.2. Create default project for existing data during migration
- [x] 1.5.3.3. Update all service layer calls to use unified Repository
- [x] 1.5.3.4. Update Transaction module to use unified Repository with project context
- [x] 1.5.3.5. Remove ConversationRepo, MessageRepo, EngineSessionRepo, AnalysisResultRepo modules
- [x] 1.5.3.6. Update all tests to use unified Repository with project context
- [x] 1.5.3.7. Update core domain models to include project context
- [x] 1.5.3.8. Update inter-app communication to pass project context
- [x] 1.5.3.9. Verify all functionality works with project-scoped unified repository
- [x] 1.5.3.10. Performance test unified repository vs old repositories
