defmodule RubberDuck.SelfCorrection.EvaluatorTest do
  ...
  describe "evaluate/4" do
    ...
    test "detects semantic issues" do
      ...
      # Poor naming
      assert result.dimensions.semantics < 0.8
    end
    ...
    test "detects logic issues" do
      ...
      # Constant condition
      assert result.dimensions.logic < 0.8
    end
  ...
  describe "dimension scoring" do
    ...
    test "clarity scoring considers sentence length" do
      ...
      unclear =
        "This is a very long sentence that goes on and on and on without any breaks or pauses making it very difficult to read and understand what the main point is supposed to be."
