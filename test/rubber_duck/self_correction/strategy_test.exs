defmodule RubberDuck.SelfCorrection.StrategyTest do
  ...
  describe "Semantic Strategy" do
    ...
    test "detects long sentences in text" do
      content =
        "This is an extremely long sentence that continues on and on without any breaks or pauses making it very difficult for readers to follow the train of thought and understand what the main point is supposed to be."
  ...
  describe "Strategy priorities" do
    test "strategies have correct priorities" do
      # Highest - syntax first
      assert Syntax.priority() == 100
      # High - logic critical
      assert Logic.priority() == 90
      # Medium - semantics important
      assert Semantic.priority() == 80
    end
  end
