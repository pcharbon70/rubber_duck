defmodule RubberDuck.Planning.Execution.HistoryTest do
  ...
  describe "record_thought/3" do
    ...
    test "accumulates multiple thoughts for same task" do
      ...
      assert List.first(updated_history.thoughts[task_id]) == thought2  # Latest first
    end
  end
  ...
  describe "record_failure/3" do
    ...
    test "increments attempt number for multiple failures" do
      ...
      assert List.first(failures).attempt_number == 1  # Latest first, but attempt 1 from first failure
    end
  end
  ...
  describe "get_task_entries/2" do
    test "filters entries by task" do
      ...
      assert length(task1_entries) == 2  # 1 thought + 1 observation
      assert length(task2_entries) == 1  # 1 thought only
    end
  end
  ...
  describe "get_task_history/2" do
    test "provides detailed task history" do
      ...
      assert length(task_history.entries) == 3  # thought + observation + failure
    end
  end
