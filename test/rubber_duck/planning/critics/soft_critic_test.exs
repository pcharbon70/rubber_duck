defmodule RubberDuck.Planning.Critics.SoftCriticTest do
  ...
  describe "StyleChecker" do
    ...
    test "checks description quality" do
      target = %{
        description:
          "This task processes user registration by validating input data, creating user records, and sending confirmation emails."
      }
  ...
  describe "BestPracticeValidator" do
    ...
    test "warns about multiple responsibilities" do
      target = %{
        description:
          "Create user, update profile, delete old records, fetch permissions, process payments, and manage notifications",
        complexity: :very_complex
      }
