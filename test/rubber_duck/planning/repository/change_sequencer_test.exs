defmodule RubberDuck.Planning.Repository.ChangeSequencerTest do
  ...
  describe "create_sequence/3" do
    ...
    test "orders phases by dependencies" do
      ...
      change_requests = [
        %{
          id: "change1",
          files: ["lib/module_b.ex"],  # Depends on module_c
          type: :feature,
          priority: :medium,
          dependencies: [],
        ...
        %{
          id: "change2", 
          files: ["lib/module_c.ex"],  # No dependencies
          type: :feature,
          priority: :medium,
          dependencies: [],
    ...
    test "detects file modification conflicts" do
      ...
      change_requests = [
        %{
          id: "change1",
          files: ["lib/module_a.ex"],  # Same file
          type: :feature,
          priority: :high,
          dependencies: [],
          estimated_effort: 2.0,
        ...
        %{
          id: "change2",
          files: ["lib/module_a.ex"],  # Same file - conflict!
          type: :bugfix,
          priority: :medium,
          dependencies: [],
          estimated_effort: 1.0,
    ...
    test "identifies parallel execution opportunities" do
      ...
      change_requests = [
        %{
          id: "change1",
          files: ["lib/module_a.ex"],  # Independent files
          type: :feature,
          priority: :medium,
          dependencies: [],
          estimated_effort: 1.0,
        ...
        %{
          id: "change2", 
          files: ["lib/module_b.ex"],  # Independent files
          type: :feature,
          priority: :medium,
          dependencies: [],
          estimated_effort: 1.0,
      ...
      assert length(parallel_phases) >= 0  # May or may not find parallel opportunities
    end
    ...
    test "creates validation points based on strategy" do
      ...
      assert {:ok, sequence} = ChangeSequencer.create_sequence(
        repo_analysis, 
        change_requests,
      ...
      assert {:ok, aggressive_sequence} = ChangeSequencer.create_sequence(
        repo_analysis,
        change_requests, 
  ...
  describe "validate_sequence/2" do
    ...
    test "detects validation errors" do
      ...
      invalid_sequence = %{
        phases: [%{phase: 1, name: "Phase 1", files: [], dependencies: [], can_parallel: false, validation_required: false}],
        parallel_groups: [],
        conflicts: [%{
          type: :file_modification,
          files: ["test.ex"],
          description: "Conflict",
          resolution_strategy: nil,  # Unresolved!
          severity: :high
        }],
        validation_points: [],
  ...
  describe "suggest_improvements/2" do
    ...
    test "suggests phase consolidation when appropriate" do
      ...
      change_requests = Enum.map(1..5, fn i ->
        %{
          id: "change#{i}",
