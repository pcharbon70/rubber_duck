defmodule RubberDuck.Enhancement.MetricsCollectorTest do
  ...
  describe "aggregate/1" do
    ...
    test "calculates distributions" do
      metrics_list = Enum.map(1..10, fn i ->
  ...
  describe "quality calculations" do
    ...
    test "calculates readability scores" do
      ...
      complex = "This is an extraordinarily complicated and convoluted sentence that contains numerous subclauses and parenthetical expressions which make it exceedingly difficult to parse and comprehend."
