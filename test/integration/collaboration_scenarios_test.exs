defmodule RubberDuckWeb.Integration.CollaborationScenariosTest do
  ...
  describe "collaborative editing" do
    ...
    test "handles conflicting edits with operational transformation", %{
      conn: conn,
      user1: user1,
      user2: user2,
      project: project
  ...
  describe "shared selections and cursors" do
    ...
    test "highlights shared selections", %{conn: conn, user1: user1, user2: user2, project: project} do
      ...
      # Selection in user's color
      assert html1 =~ view1.assigns.user_colors[user2.id]
    end
  ...
  describe "session management" do
    test "owner can manage session permissions", %{
      conn: conn,
      user1: user1,
      user2: user2,
      user3: user3,
