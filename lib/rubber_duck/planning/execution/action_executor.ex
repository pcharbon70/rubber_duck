defmodule RubberDuck.Planning.Execution.ActionExecutor do
  ...
  defp extended_timeout(%{complexity: :very_complex}), do: 600_000  # 10 minutes
  defp extended_timeout(%{complexity: :complex}), do: 300_000      # 5 minutes
  defp extended_timeout(_), do: 120_000                            # 2 minutes
  ...
  defp calculate_retry_delay(task, execution_state) do
    ...
    trunc(min(delay + jitter, 30_000))  # Max 30 seconds
  end
