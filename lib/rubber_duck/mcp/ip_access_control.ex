defmodule RubberDuck.MCP.IPAccessControl do
  ...
  def handle_cast({:report_failure, ip_address, reason}, state) do
    # Track failures
    failures =
      case :ets.lookup(:mcp_ip_failures, ip_address) do
  ...
  def handle_info(:cleanup, state) do
    ...
    # 5 minutes
    cache_cutoff = System.monotonic_time(:second) - 300
      ...
      :miss ->
        ...
        cond do
          ...
          true ->
            ...
            geo_decision =
              if state.config.enable_geo_blocking do
