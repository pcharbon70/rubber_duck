defmodule RubberDuck.Engine.CapabilityRegistry do
  ...
  defmodule State do
    @moduledoc false
    defstruct [
      capabilities: %{},     # capability => [engine_names]
  ...
  def handle_call({:register_engine, engine_config}, _from, state) do
    ...
    capabilities = if Code.ensure_loaded?(engine_config.module) and
    ...
    new_capabilities = Enum.reduce(capabilities, state.capabilities, fn cap, acc ->
