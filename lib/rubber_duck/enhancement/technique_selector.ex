defmodule RubberDuck.Enhancement.TechniqueSelector do
  ...
  defp calculate_complexity(task) do
    ...
    indicator_bonus = Enum.reduce(complexity_indicators, 0, fn {pattern, weight}, acc ->
  ...
  defp get_recommendations(analysis, task_type) do
    ...
    recommendations = if analysis.requires_context || analysis.content_length > 500 do
      [{:rag, %{
    ...
    recommendations = if analysis.requires_reasoning || analysis.complexity > 0.6 do
      [{:cot, %{
    ...
    recommendations = if analysis.error_prone || analysis.complexity > 0.7 do
      [{:self_correction, %{
