defmodule RubberDuck.Status.Monitor do
  ...
  @default_thresholds %{
    ...
    throughput: %{warning: 100, critical: 50},  # messages/second (lower is bad)
  ...
  def handle_call({:update_thresholds, metric_type, warning, critical}, _from, state) do
    new_thresholds = Map.put(state.thresholds, metric_type, %{
      warning: warning,
      critical: critical
    })
  ...
  defp update_error_rate(state) do
    ...
    new_rate = current_rate + 0.001  # Increment by 0.1%
